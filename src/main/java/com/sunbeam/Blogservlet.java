...
public class Blogservlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest req, HttpServletResponse resp)
        ...
        // String appTitle = ctx.getServletContextName();
        ...
        try (CategoryDao categoryDao = new CategoryDao()) {
            ...
            for (Blog b : list) {
                ...
                User u = us.findById(b.getUserId());
                out.printf("<td>%s</td>", u.getName());
                // out.println("<td></td>");
                
                out.println("<td>");
                if (b.getUserId() == user.getId())
                    out.printf(
                            "<a href='editblog?id=%d'><img src='edit.png' alt='Edit' width='19' height='18'></a>  <a href='delblog?id=%d'><img src=' del.png' alt='Delete' width='19' height='16'></a>",
                            b.getId(), b.getId());
                out.println("</td>");
                out.println("</tr>");
            }
